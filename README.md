...
[![CI](https://github.com/EReaso/cookbook/actions/workflows/ci.yml/badge.svg?branch=main)](https://github.com/EReaso/cookbook/actions/workflows/ci.yml)
...
I'm hosting this repo on my [gitea instance. ](https://git.raccoonsarecool.xyz/EReaso/cookbook)
All commits to either remote and CI should sync between GitHub and Gitea.

## A note on the README

Part of the README for this repo has been generated AI and modified, because I would prefer to focus on development
over writing the README.
...
## Contributing &ndash; Not just for devs!

Obviously, software development help would be great, but **feature requests are really great too!**
At some point, I will be happy with this repo and need more feature requests to work on. Please create a discussion post
or issue.
...
If you have PostgreSQL running locally and want to use it, you probably know how to set up Docker Compose. Skip
to [Use an existing PostgreSQL server](#Use-an-existing-PostgreSQL-server)
...
2. **Create a protected database volume:**
